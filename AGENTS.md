...
- The legacy `https://sales-words-hifiaudio.vercel.app/` root redirects permanently to `https://tellynai.com/customer`; the canonical `/customer` experience proxies a pinned content deployment so the redirect cannot loop back into itself.
