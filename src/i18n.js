...
const en = {
  '品牌说明：官方英文品牌为 Tellyn AI，中文公司品牌为图灵驭界，官网为 tellynai.com。':'Brand note: the official English brand is Tellyn AI, its Chinese company brand is 图灵驭界, and the official website is tellynai.com.',
...
const ar = {
  '品牌说明：官方英文品牌为 Tellyn AI，中文公司品牌为图灵驭界，官网为 tellynai.com。':'ملاحظة حول العلامة: العلامة الإنجليزية الرسمية هي Tellyn AI، والعلامة الصينية للشركة هي 图灵驭界، والموقع الرسمي هو tellynai.com.',
